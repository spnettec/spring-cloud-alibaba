...
@SpringBootTest(classes = NacosConfigurationNewTest.TestConfig.class, properties = {
		...
		"spring.cloud.nacos.config.cluster-name=test-cluster", "spring.cloud.nacos.config.file-extension=properties",
...
public class NacosConfigurationNewTest {
	...
	private void checkShareConfigs() throws Exception {
		...
		assertThat(properties.getSharedConfigs()).contains(new Config("common1.properties"),
				new Config("common2.properties"));
	}

	private void checkExtensionConfigs() throws Exception {
		assertThat(properties.getExtensionConfigs() != null);
		assertThat(properties.getExtensionConfigs()).contains(new Config("ext-config-common01.properties"),
